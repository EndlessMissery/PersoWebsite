...
const ResumeSection = () => {
  // Typewriter effects
  const resumeHeader = useTypewriter({ words: ["Resume"], typeSpeed: 30, delaySpeed: 2000, initialDelay: 0, cursor: true, cursorStyle: "|" });
  const resumeContent = useTypewriter({ words: [" "], cursor: false, cursorStyle: "|", typeSpeed: 40, delaySpeed: 2000, initialDelay: 0 });
